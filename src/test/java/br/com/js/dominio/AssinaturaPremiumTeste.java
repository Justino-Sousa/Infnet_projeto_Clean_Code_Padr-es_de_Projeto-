...
public class AssinaturaPremiumTeste {

	private Catalogo catalogo = new Catalogo();
	AssinaturaPremium assinatura = new AssinaturaPremium(catalogo);
	...
	void getPrecoDaAssinaturaTeste() {
		assertEquals(Double.valueOf("200.0"), assinatura.getPrecoDaAssinatura());
	...
	void getTipoAssinaturaTeste() {
		...
		assertEquals(TipoAssinatura.PLATINUM, assinatura.getTipoAssinatura());
	}
